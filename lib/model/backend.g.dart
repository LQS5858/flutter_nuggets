...
BackEnd _$BackEndFromJson(Map<String, dynamic> json) {
  return BackEnd(
    ...
    (json['data'] as List)
        ?.map((e) =>
            e == null ? null : BackData.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
BackData _$BackDataFromJson(Map<String, dynamic> json) {
  return BackData(
...
Map<String, dynamic> _$BackDataToJson(BackData instance) => <String, dynamic>{
