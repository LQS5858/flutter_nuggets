...
class Popular extends Object {
  ...
  factory Popular.fromJson(Map<String, dynamic> srcJson) =>
      _$PopularFromJson(srcJson);
...
@JsonSerializable()
class Item_info extends Object {
  ...
  factory Item_info.fromJson(Map<String, dynamic> srcJson) =>
      _$Item_infoFromJson(srcJson);

  Map<String, dynamic> toJson() => _$Item_infoToJson(this);
}
